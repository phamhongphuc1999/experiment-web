...
export function useCategories(params: CategoryParamsType, query?: OptionalQueryType) {
  const result = useQuery({
    ...query,
    queryKey: [QUERY_KEY.wordCategory, params?.filter, params?.pagination],
    queryFn: () => wordClientApi.getCategory(params),
  });
